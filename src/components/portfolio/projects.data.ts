...
export const projects: Project[] = [
  ...
  {
    slug: 'icc-calamuchita',
    category: 'Web · Landing Institucional',
    title: 'ICC Calamuchita',
    description: 'Landing institucional de ICC Calamuchita – Ing. Carbone Construcciones: movimiento de suelos, construcción de piscinas, tratamiento de aguas residuales y redes de agua en el Valle de Calamuchita. Sitio one-page con navegación por anclas, galería de obra, SEO con JSON-LD y contacto directo por WhatsApp.',
    tech: ['Next.js 16', 'React 19', 'Tailwind CSS v4', 'Framer Motion', 'Embla Carousel', 'TypeScript'],
    accent: '#0ea5e9',
    link: 'https://icc-calamuchita.com.ar',
    featured: true,
  },
  {
    slug: 'magnolia-joyas',
